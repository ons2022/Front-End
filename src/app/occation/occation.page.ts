...
@Component({
  ...
  templateUrl: './occation.page.html',
  styleUrls: ['./occation.page.scss'],
})
export class OccationPage implements OnInit {
...
getvoiture(){
  this.httpClient.get<any>("http://127.0.0.1:8000/getVoitureOccasionWithoutScrappingMethod/")
  .subscribe(data => {
    console.log(data);
